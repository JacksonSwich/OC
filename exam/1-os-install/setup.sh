...
# Если SUDO_USER пуст (запуск через sudo -i) — берём реального пользователя
...
echo ""
echo "[0/17] Обновление пакетов системы..."
...
echo ""
echo "[1/17] Настройка параметров ядра (sysctl)..."
...
# ========== 3. УДАЛЕННЫЙ ДОСТУП ==========
echo ""
echo "[3/17] Настройка удаленного доступа..."
echo ""
...
# ========== 4. СЕТЕВОЙ ИНТЕРФЕЙС ==========
echo ""
echo "[4/17] Определение сетевых интерфейсов..."
...
echo ""
echo "[5/17] Проверка сетевого соединения..."
...
# ========== 6. БАЗОВОЕ ПО ==========
echo ""
echo "[6/17] Установка базового ПО..."
...
echo ""
echo "[6a/17] Установка шрифтов Windows..."
...
echo ""
echo "[6b/17] Установка Python-пакетов..."
...
echo ""
echo "[7/17] Установка виртуального принтера..."
...
echo ""
echo "[8/17] Резервное копирование системы..."
...
echo ""
echo "[9/17] Создание установочного образа (клон системы)..."
...
echo ""
echo "[10/17] Настройка точек восстановления (timeshift)..."
...
timeshift --create --comments "Первый снепшот после установки" 2>/dev/null || \
    echo "  (timeshift: первый снепшот не создался — создай вручную: sudo timeshift-gtk → Create)"

echo "  + Timeshift установлен"

# ========== 11. ГРУППЫ ПОЛЬЗОВАТЕЛЕЙ ==========
echo ""
echo "[11/17] Создание групп пользователей и настройка прав..."
...
# ========== 12. ПРАВА ДОСТУПА ==========
echo ""
echo "[12/17] Настройка прав доступа..."
...
echo ""
echo "[13/17] Настройка аутентификации и журнала мониторинга..."
