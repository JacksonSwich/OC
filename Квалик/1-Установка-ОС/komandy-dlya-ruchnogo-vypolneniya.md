...
## 3. Удаленный доступ (xrdp) — 2.0 балла
...
**Преподу сказать:** Поставил xrdp — можно зайти удаленно через RDP с любой машины. Удобно для администрирования.
...
# (можно через GUI: sudo timeshift-gtk)
```
